...
public class FlexMenu extends HorizontalLayout {
    ...
    private void initMenuHistory() {
        ...
        notes.addSeparator();
        notes.addItem("New Note", command);
        ...
        humanRights.addItem("Report Violations", command);
        humanRights.addSeparator();
