 ...
 */
@Singleton
public class GlobalVoicesCrawlerJP extends GlobalVoicesAbstractCrawler {

    public GlobalVoicesCrawlerJP() {
        super("https://jp.globalvoices.org");
    }
    ...
    public NewsSource getMySource() {
        String sourceId = "global-voices-jp";
        String name = "Global Voices JP";
        String description = "";
        String url = getUrl();
