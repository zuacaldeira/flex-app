 ...
 */
@Singleton
public class GlobalVoicesCrawlerMY extends GlobalVoicesAbstractCrawler {

    public GlobalVoicesCrawlerMY() {
        super("https://my.globalvoices.org");
    }
    ...
    public NewsSource getMySource() {
        String sourceId = "global-voices-my";
        String name = "Global Voices MY";
        String description = "";
        String url = getUrl();
